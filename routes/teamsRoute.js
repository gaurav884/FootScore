...
router.post("/update-teams", (req, res) => {
  ...
  var options = {
    ...
    params: { league: `${req.body.id}`, season: '2021' },
    headers: {
...
router.post("/find-team", (req, res) => {
  ...
  var options = {
    ...
    params: { league: req.body.leagueid, season: '2021', team: req.body.teamid },
    headers: {
      'x-rapidapi-host': 'api-football-v1.p.rapidapi.com',
      'x-rapidapi-key': process.env.API_KEY
    }
...
router.post("/find-player", (req, res) => {
  ...
  var options = {
    ...
    params: { team: req.body.teamid, league: req.body.leagueid, season: '2021', search: req.body.name },
    headers: {
      'x-rapidapi-host': 'api-football-v1.p.rapidapi.com',
      'x-rapidapi-key': process.env.API_KEY
    }
